import { conseguirCuentaPorUsername } from "../gestores/gestor_cuentas.js";
...
export function datos_validos() {
  ...
  let encontrado = conseguirCuentaPorUsername(username.value.trim());
  ...
  if (
    ...
    mostrar_error(
      password,
      "error_password",
      "La contraseña debe tener al menos 8 letras, 1 minuscula,1 mayuscula, 1 numero y 1 simbolo ",
    );
    formulario_valido = false;
  }
